...
public class OBJLoader {
    ...
    private static void processFaceValue(IdxGroup indices, List<Vector2f> textCoordList, List<Vector3f> normList,
	    List<Integer> indicesList, float[] textCoordArray, float[] normArray) {
